...
def get_leftover_of_bills(amount: float, denomination: int) -> int:
    """
...
def exchangeable_value(budget: float, exchange_rate: float, spread: int, denomination: int) -> int:
    ...
    change = get_change(budget, adjusted_exchange_rate)

    bills = get_value_of_bills(get_number_of_bills(exchanged_money, denomination), denomination)
